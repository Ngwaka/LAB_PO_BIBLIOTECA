...
public class EsempioMain { 
	...
	public static void main(String[] args) {
		...
		try {
			...
			al.addVolo("AZ321", "L734", "TorinoTRN", "ParisCDG", "Marted�");
			al.addVolo("AZ123", "E95", "LondonGTW", "TorinoTRN", "Luned�");
//			al.cancelVolo("AZ123");
			...
			lu.addAereo("CR9", 60);
			lu.addVolo("LH274", "CR9", "ParisCDG", "TorinoTRN", "Gioved�");
			lu.addVolo("LH273", "L734", "ParisCDG", "TorinoTRN", "Venerd�");
